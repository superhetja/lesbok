...
import { InitialsButton } from "../../components/Buttons"
...
const LoginScreen = () =>
{
	 ...
	 */
	const renderSelectRole = (roles: Roles[], onRoleSelect: (role: Roles) => void) => {
		return(
			// <View style={{ ,justifyContent: 'center', alignItems: 'center', height: 100}}>
				<Layout style={styles.centerModal}>
					<Text category='s1' style={{marginBottom: 20}}>Vinsamlegast veldu hlutverk:</Text>
					{
						roles.map(role => (
							<Button
