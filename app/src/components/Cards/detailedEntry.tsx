...
import { EntryWithUser } from '../../utils/types';
...
function DetailedEntry({ entry }: EntryProps) {
	return (
		<View style={{ padding: 10 }}>
			...
			<View style={{ marginRight: 100 }}>
				...
				<View style={{ flexDirection: 'row' }}>
					...
					<Text style={styles.text}>
						{getDateFormated(entry.date_of_entry)}
					</Text>
				</View>
				<View style={{ flexDirection: 'row' }}>
					<Text style={styles.bold}>Búin til: </Text>
					<Text style={styles.text}>
						{getDateFormatedWithTime(entry.created)}{' '}
					</Text>
				</View>
				<View style={{ flexDirection: 'row' }}>
					<Text style={styles.bold}>Síðast Breytt: </Text>
					<Text style={styles.text}>
						{getDateFormatedWithTime(entry.modified)}
					</Text>
				</View>
				<View style={{ flexDirection: 'row' }}>
