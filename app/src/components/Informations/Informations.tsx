...
const Informations = () => {
	...
	return (
		...
		<Text style={{fontSize: 20, fontWeight: 'bold', paddingTop: 10}} >Mikilvægi heimalesturs</Text>
		<View style={{}}>
		<Text style={{paddingTop: 10, alignItems: 'center'}}>Mjög mikilvægt er að nemendur þjálfi sig heima í lestri. Lestur er undirstaða af öllu námi og því er mikilvægt að nemendur fái sem mestu æfingu í lestri. Nemendur þurfa því að æfa sig heima og í skólanum, nemendur þurfa mismikla æfingu til þess að ná lestrarmarkmiðum og því er best að hafa samband við kennara ef áhyggjur kunna að vakna varðandi lestrargetu nemenda.</Text>
		</View>
		</View>
		</>
	)
